...
try {
    if (isset($_POST['fichaatendimento'])) {
        ...
        $stmt->execute([$_POST['fichaatendimento']]);
        $user = $stmt->fetch();
    }
        ...
        <div class="container text-center">
            <div class="card bg-light mb-3">
                <div class="card-header"><h4>Ficha de acolhimento individual</h4></div>
                    ...
                    <label required>Você é uma pessoa com deficiência?</label>
                    <ul class="radio">
                        <li><input type="radio" class="radio-input" value="sim" id="field" name='radio'/> Sim</li>
                        <li><input type="radio"  class="radio-input" value="nao" id="field" name='radio'/> Não</li>
                        <li><input type="radio"  class="radio-input" value="naosei" id="field" name='radio'/> Não sabe/não informou</li>    
                    ...
                    <label>Bairro:</label>
                        ...
                        <label required>Em situação de rua</label>
                            <ul class="radio">
                                <li><input type="radio" class="radio-input" value="sim" id="field" name='radio'/> Sim</li>
                                <li><input type="radio"  class="radio-input" value="nao" id="field" name='radio'/> Não</li>
                                <li><input type="radio"  class="radio-input" value="naosei" id="field" name='radio'/> Não sabe/não informou</li>    
                        ...
                        <div class="row">
                            ...
                            <label>Qual é a expectativa do usuário e/ou da família em relação a esse atendimento?</label>
                            ...
                            <label>Gostaria de atendimento presencial na CPDrogas?</label>
                            <ul class="radio">
                                <li><input type="radio" class="radio-input" value="sim" id="field" name='radio'/> Sim</li>
                                <li><input type="radio"  class="radio-input" value="nao" id="field" name='radio'/> Não</li>
                            </ul>
